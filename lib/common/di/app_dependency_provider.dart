...
class CollectionsDependenciesProvider extends MultiProvider {
  CollectionsDependenciesProvider({
    ...
    Provider<StatisticCollection>(create: (context) => StatisticCollection()),
...
class RepoDependenciesProvider extends MultiProvider {
  RepoDependenciesProvider({
    ...
    Provider<DeleteUserRepo>(create: (context) => DeleteUserRepo(usersCollection: context.read<UsersCollection>(), statisticCollection:  context.read<StatisticCollection>())),
